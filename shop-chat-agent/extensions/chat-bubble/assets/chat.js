...
(function() {
  ...
  const ShopAIChat = {
    /**
     * Base URL for the app backend (theme block setting or default).
     * @returns {string} Origin without trailing slash
     */
    getChatApiBase: function() {
      const raw = (window.shopChatConfig && window.shopChatConfig.chatApiBase) || 'https://localhost:3458';
    ...
    API: {
      ...
      streamResponse: async function(userMessage, conversationId, messagesContainer) {
        ...
        try {
          ...
          const streamUrl = ShopAIChat.getChatApiBase() + '/chat';
        ...
        switch (data.type) {
          ...
          case 'fallback_notice':
            ...
            if (data.notice) {
              ...
              note.classList.add('shop-ai-message', 'assistant', 'shop-ai-fallback-notice');
      ...
      fetchChatHistory: async function(conversationId, messagesContainer) {
        try {
          ...
          const historyUrl = `${ShopAIChat.getChatApiBase()}/chat?history=true&conversation_id=${encodeURIComponent(conversationId)}`;
    ...
    Auth: {
      ...
      startTokenPolling: function(conversationId, messagesContainer) {
        ...
        const poll = async () => {
          ...
          try {
            const tokenUrl = ShopAIChat.getChatApiBase() + '/auth/token-status?conversation_id=' +
