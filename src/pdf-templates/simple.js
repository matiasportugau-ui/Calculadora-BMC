...
.hdr{display:flex;justify-content:space-between;align-items:center;border-bottom:2pt solid #003366;padding-bottom:4mm;margin-bottom:3mm}
.hdr-left{display:flex;align-items:center;gap:8px}
.hdr-mark{width:28px;height:28px;background:#003366;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:14pt;font-weight:900;color:#fff}
.hdr-name{font-size:11pt;font-weight:800;color:#003366;letter-spacing:.03em}
.hdr-sub{font-size:6pt;color:#667085;letter-spacing:.1em;text-transform:uppercase}
.hdr-badge{background:#003366;color:#fff;font-size:7pt;font-weight:700;padding:3px 10px;border-radius:12px;letter-spacing:.08em;text-transform:uppercase}
...
.bom .bg td{background:#EAF0F8;color:#003366;font-weight:700;border-left:2.5pt solid #003366;padding:3px 5px}
...
.trt{border-top:1.5pt solid #003366;margin-top:2px;padding-top:2px;font-size:12pt;font-weight:800;color:#003366}
.terms{margin-bottom:2mm;padding:4px 8px;background:#F8F9FA;border-radius:4px;border-left:2.5pt solid #003366}
.terms-title{font-size:7pt;font-weight:700;color:#003366;text-transform:uppercase;letter-spacing:.1em;margin-bottom:2px}
...
.bank{display:grid;grid-template-columns:1fr 1fr;gap:1px 8px;padding:4px 8px;background:#003366;color:rgba(255,255,255,.7);border-radius:4px;font-size:7.5pt;margin-bottom:2mm}
