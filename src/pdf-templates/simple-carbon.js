...
.hdr{background:linear-gradient(135deg,#111827 0%,#1F2937 100%);padding:7mm 8mm 5.5mm;position:relative;overflow:hidden;flex-shrink:0}
...
.hdr-mark{width:34px;height:34px;background:linear-gradient(135deg,#F59E0B,#D97706);border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:17pt;font-weight:900;color:#111827;box-shadow:0 3px 12px rgba(245,158,11,.45)}
...
.hdr-badge{display:inline-block;background:#F59E0B;color:#111827;font-size:7.5pt;font-weight:900;padding:3px 12px;border-radius:3px;letter-spacing:.1em;text-transform:uppercase;margin-bottom:4px}
...
.client-card{background:#fff;border-left:4pt solid #F59E0B;border-radius:0 6px 6px 0;padding:4px 10px;margin-bottom:2.5mm;display:grid;grid-template-columns:1fr 1fr 1fr;gap:1.5mm 8mm;box-shadow:0 2px 8px rgba(0,0,0,.07)}
.client-card div{font-size:7.5pt;color:#6B7280}
.client-card b{color:#1F2937;font-weight:600}
.prod{background:#fff;border-bottom:2pt solid #F59E0B;padding:3px 8px;margin-bottom:2mm;font-size:8pt;box-shadow:0 1px 4px rgba(0,0,0,.06)}
.prod strong{color:#D97706}
...
.bom .bg td{background:#F59E0B!important;color:#111827!important;font-weight:700!important;padding:3px 5px!important;border:none!important}
.bom tr:nth-child(even) td{background:rgba(249,250,251,1)}
.tots{display:flex;justify-content:flex-end;margin-bottom:2mm}
.ti{min-width:200px;background:#F59E0B;border-radius:6px;padding:6px 10px}
...
.dark-footer::before{content:'';position:absolute;top:0;left:0;right:0;height:.5pt;background:linear-gradient(90deg,#F59E0B,rgba(245,158,11,0))}
.terms-title{font-size:6.5pt;font-weight:700;color:#F59E0B;text-transform:uppercase;letter-spacing:.12em;margin-bottom:3px}
