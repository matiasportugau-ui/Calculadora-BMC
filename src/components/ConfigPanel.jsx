...
import { Settings, RotateCcw, DollarSign, Sliders, Calculator, Package } from "lucide-react";
...
export default function ConfigPanel({ visible, onClose, onConfigChange }) {
  ...
  const [tab, setTab] = useState("general"); // "general" | "precios" | "formulas" | "productos"
    ...
    >
      ...
      <div
        style={{
          position: "relative",
          width: "100%",
          maxWidth: tab === "precios" || tab === "formulas" || tab === "productos" ? 900 : 400,
          background: C.bg,
