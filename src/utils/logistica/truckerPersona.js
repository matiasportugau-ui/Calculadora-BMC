...
export const PERSONA_KEY = "bmc-logistica-trucker-persona-v1";

export const DEFAULT_LOOK =
  "Camisa a cuadros (squares) negra y roja, gorra de camionero americano.";
...
export const DEFAULT_CORRECTIONS = Object.freeze([
  ...
  "Si el operador corrige o pide cambiar la forma/look, aplicá y persistí en este entorno local.",
]);
