...
const FORMULA_FACTORS = [
  ...
  /** @deprecated usar rosca_extra_metal_m + rosca_extra_hormigon_m */
  { path: "FIJACIONES_VARILLA.rosca_extra_metal_hormigon_m", label: "Rosca útil extra metal/hormigón (m) — legacy", default: 0.1, formula: "solo fallback si faltan claves nuevas", unidad: "m", categoria: "Fijaciones Techo" },
  { path: "FIJACIONES_VARILLA.rosca_extra_madera_m", label: "Rosca útil extra madera (m)", default: 0.2, formula: "tramo varilla = espesor panel (m) + valor (ISODEC madera)", unidad: "m", categoria: "Fijaciones Techo" },
