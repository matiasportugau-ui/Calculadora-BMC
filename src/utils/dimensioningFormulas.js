...
const FORMULA_FACTORS = [
  ...
  { path: "FIJACIONES_VARILLA.rosca_extra_metal_m", label: "Rosca útil extra metal (m)", default: 0.1, formula: "tramo varilla = espesor panel (m) + valor (ISODEC metal)", unidad: "m", categoria: "Fijaciones Techo" },
  { path: "FIJACIONES_VARILLA.rosca_extra_hormigon_m", label: "Rosca útil extra hormigón (m)", default: 0.2, formula: "tramo varilla = espesor panel (m) + valor (ISODEC hormigón)", unidad: "m", categoria: "Fijaciones Techo" },
  { path: "FIJACIONES_VARILLA.rosca_extra_madera_m", label: "Rosca útil extra madera (m)", default: 0.05, formula: "tramo varilla = espesor panel (m) + valor (ISODEC madera)", unidad: "m", categoria: "Fijaciones Techo" },
  ...
  { path: "FIJACIONES_CABALETE.anclajes_por_apoyo", label: "Anclajes por línea de apoyo (por panel)", default: 3, formula: "grilla = valor × paneles × apoyos", unidad: "unid", categoria: "Fijaciones Techo" },
  { path: "FIJACIONES_CABALETE.factor_largo", label: "Factor largo caballete — fallback autoportancia (m)", default: 2.9, formula: "apoyos (si falta autoportancia real del panel) = ceil(largo/valor) + 1", unidad: "m", categoria: "Fijaciones Techo" },
  { path: "FIJACIONES_CABALETE.espaciado_lateral", label: "Espaciado fijación lateral caballete (m)", default: 2.5, formula: "laterales = 2 × (floor(largo/valor) + 1)", unidad: "m", categoria: "Fijaciones Techo" },
