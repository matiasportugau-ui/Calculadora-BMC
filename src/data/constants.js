...
export const PANELS_TECHO = {
  ISODEC_EPS: {
    ...
    esp: {
      100: { venta: 41.15, web: 41.066, costo: 35.79, ap: 5.5 },
      150: { venta: 43.677, web: 43.584, costo: 37.98, ap: 7.5 },
      200: { venta: 48.967, web: 48.862, costo: 42.58, ap: 9.1 },
      250: { venta: 53.82,  web: 53.705, costo: 46.80, ap: 10.4 },
    },
  ...
  ISODEC_PIR: {
    ...
    esp: {
      50:  { venta: 40.176, web: 46.872, costo: 33.48, ap: 3.5 },
      80:  { venta: 45.852, web: 53.494, costo: 38.21, ap: 5.5 },
      120: { venta: 55.116, web: 64.302, costo: 45.93, ap: 7.6 },
    },
  ...
  ISOROOF_3G: {
    ...
    esp: {
      ...
      40:  { venta: 43.148,  web: 43.056, costo: 37.52, ap: 3.0 },
      50:  { venta: 45.2295, web: 45.133, costo: 39.33, ap: 3.3 },
      80:  { venta: 53.176,  web: 53.062, costo: 46.24, ap: 4.0 },
      100: { venta: 58.3855, web: 58.261, costo: 50.77, ap: 4.5 },
    },
  ...
  ISOROOF_PLUS: {
    ...
    esp: {
      ...
      80: { venta: 60.467,  web: 60.338, costo: 52.58, ap: 4.0 },
    },
    col: ["Blanco", "Gris", "Rojo"],
...
export const PANELS_PARED = {
  ISOPANEL_EPS: {
    ...
    esp: {
      50:  { venta: 37.41, web: 37.328, costo: 32.53, ap: null },
      100: { venta: 38.824,  web: 38.741, costo: 33.76, ap: null },
      150: { venta: 43.677,  web: 43.584, costo: 37.98, ap: null },
      200: { venta: 48.967,  web: 48.862, costo: 42.58, ap: null },
      250: { venta: 53.82,   web: 53.705, costo: 46.80, ap: null },
    },
    col: ["Blanco", "Gris", "Rojo"], colNotes: {}, colMax: {},
  ...
  ISOWALL_PIR: {
    ...
    esp: {
      ...
      100: { venta: 60.5475, web: 60.418,  costo: 52.65,   ap: null },
    },
    col: ["Blanco", "Gris", "Rojo"], colNotes: {}, colMax: {},
  },
  ISOFRIG_PIR: {
    ...
    esp: {
      40:  { venta: 45.36, web: 45.36,  costo: 35.00, ap: null },
      60:  { venta: 51.55, web: 51.55,  costo: 38.00, ap: null },
      80:  { venta: 56.87, web: 56.87,  costo: 42.00, ap: null },
      100: { venta: 63.07, web: 63.07,  costo: 46.00, ap: null },
      120: { venta: 73.34, web: 73.34,  costo: 52.00, ap: null },
      150: { venta: 76.51, web: 76.51,  costo: 56.00, ap: null },
      180: { venta: 91.32, web: 91.32,  costo: 68.00, ap: null },
      200: { venta: 90.99, web: 90.99,  costo: 68.00, ap: null },
    },
    col: ["Blanco"],
...
export const SCENARIOS_DEF = [
  {
    id: "solo_techo", label: "Solo Techo", icon: "🏠", description: "Cubierta con ISODEC o ISOROOF",
    familias: ["ISODEC_EPS","ISODEC_PIR","ISOROOF_3G","ISOROOF_FOIL","ISOROOF_COLONIAL","ISOROOF_PLUS"],
    hasTecho: true, hasPared: false,
  ...
  {
    id: "presupuesto_libre", label: "Presupuesto libre", icon: "📋", description: "Líneas manuales desde catálogo herrajes y anclajes",
    familias: [], hasTecho: false, hasPared: false, isLibre: true,
    visibility: { borders: false, largoAncho: false, altoPerim: false, esquineros: false, aberturas: false, camara: false, autoportancia: false, canalGot: false, p5852: false, libre: true },
    wizardSteps: [],
  },
];
