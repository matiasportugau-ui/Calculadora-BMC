...
export const SCENARIOS_DEF = [
  {
    id: "solo_techo", label: "Solo Techo", icon: "🏠",
    description: "Cubierta con ISODEC o ISOROOF",
  ...
  {
    id: "solo_fachada", label: "Solo Fachada", icon: "🏢",
    description: "Paredes y cerramientos",
  ...
  {
    id: "techo_fachada", label: "Techo + Fachada", icon: "🏗",
  ...
  {
    id: "camara_frig", label: "Cámara Frigorífica", icon: "❄️",
    description: "Cerramientos térmicos para frío",
    familias: ["ISOPANEL_EPS","ISODEC_EPS_PARED","ISOWALL_PIR"],
  ...
  {
    id: "presupuesto_libre", label: "Presupuesto libre", icon: "📋",
    description: "Líneas manuales desde catálogo herrajes y anclajes",
...
/** @deprecated Use SCENARIOS_DEF[i].visibility instead. Kept for backward compatibility. */
