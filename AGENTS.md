...
| `npm run session:video-extract -- <video.mp4> [out_dir]` | UX / demos: extrae **audio.wav** (16 kHz mono, Whisper-friendly) y **frames/** ~1 fps con **ffmpeg**. Skill [`.cursor/skills/user-session-video-to-backlog/SKILL.md`](.cursor/skills/user-session-video-to-backlog/SKILL.md); carpeta [`docs/team/ux-feedback/sessions/`](docs/team/ux-feedback/sessions/README.md). |
