...
**WhatsApp + Drive knowledge pack** (context for a connector/agent, not a shipped sync): [`../team/connectors/whatsapp-drive/README.md`](../team/connectors/whatsapp-drive/README.md).
