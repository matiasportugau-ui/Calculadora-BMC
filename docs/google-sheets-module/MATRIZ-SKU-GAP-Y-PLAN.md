...
2. **Hecho en repo (2026-04-05):** el campo `sku` en `constants.js` y en `PanelinCalculadoraV3_legacy_inline.jsx` usa ya **GFFPIR***/**GLLPIR*** (trazabilidad UI/PDF alineada al import CSV).
