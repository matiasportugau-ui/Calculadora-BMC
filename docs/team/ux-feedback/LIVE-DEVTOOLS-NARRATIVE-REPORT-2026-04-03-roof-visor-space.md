...
- [x] Reproducible en URL indicada (síntoma en prod antes del deploy)
- [x] Consola: no evaluada en esta corrida (MCP bloqueado)
- [x] Red: no evaluada en esta corrida (MCP bloqueado)
