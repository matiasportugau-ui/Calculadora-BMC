...
## Ship outcome (2026-08-05) — CONFIRMED

| Field | Value |
|-------|--------|
| PR | [#847](https://github.com/matiasportugau-ui/Calculadora-BMC/pull/847) MERGED `ff312646` |
| Closeout | [#866](https://github.com/matiasportugau-ui/Calculadora-BMC/pull/866) |
| Cloud Run | `panelin-calc-00934-lp5` (100% traffic) |
| Spec (as-built) | [`docs/team/features/WA-MEDIA-RICHNESS-SPEC.md`](../features/WA-MEDIA-RICHNESS-SPEC.md) |
| Operator doc | [`docs/wa-cockpit/MEDIA-G7G8G9.md`](../../wa-cockpit/MEDIA-G7G8G9.md) |
| Handoff | [`docs/team/HANDOFF-2026-08-05-wa-media-100.md`](../HANDOFF-2026-08-05-wa-media-100.md) |

### Goals

| Goal | Outcome |
|------|---------|
| G7 images | **PASS** — Deli JPEGs signed GET `ffd8`, messages `has_media=true` |
| G8 STT | **PASS via residual** — magic reject live; no synthetic STT; real Ogg still operator play-in |
| G9 texts | **PASS (obtainable)** — ingest/media meta path on main |

### Acceptance curls (post-verify)

- health **200**
- media unauth **401** (route exists)
- Deli auth **302** + JPEG body
- junk upload **400** `not_audio_junk`

### Anti-pattern validated

Ad-hoc Cloud Run deploys from non-main trees were overwritten by later main deploys. Official path only: PR → green CI → merge → `deploy-calc-api`.
