...
| ---------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Date**                           | 2026-04-01                                                                                                                                                                                                                                                                       |
| **Focus (one line)**               | **v3.1.3** — Logística `BmcLogisticaApp` en bundle; routing `/calculadora/logistica` + fallback SPA en `server/index.js`; validar deploy Cloud Run / Vercel.                                                                                                                    |
| **Energy / time box**              | —                                                                                                                                                                                                                                                                                |
