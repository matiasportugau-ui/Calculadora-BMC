- **2026-08-21** — `/logistica` mesa 20–21 ago extraída a `feat/logistica-mesa-depo-20260821` desde `origin/main` (no #1051). Depo BMC URUGUAY, origen por carga + salto Levantes, OSRM/Leaflet, Guardar este Mac, cola por fecha, trucker, agent `bmc-logistica`. E2E viewports 78/78. **Next:** merge PR + HITL Vercel + Cloud Run (`envios.js`). Handoff: docs/team/HANDOFF-2026-08-21-logistica-mesa.md.
