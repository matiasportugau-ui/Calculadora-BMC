...
**Status:** *As-Built* — quote engine, dual packing engines (column freight + stack ops), quote→ops bridge, Liquid Glass chrome, Ops UX F1–F6, and 1-fila tariff fix are **CONFIRMED** in code on `main`. Residual product: U3 FSM, P2 geocode, P3 CBM-as-tariff, P5 durable ENV.
...
| G8 | FSM STOP_STATUS guards | P2 | **OPEN** U3 |
