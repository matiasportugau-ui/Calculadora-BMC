...
8. Cross-reference the dev backlog — open GitHub Issues / Project **BMC Dev** (offline mirror: `docs/team/BACKLOG.md`); surface the top open `priority:P0`/`P1` cards as next steps. Board rules: `docs/team/AGILE.md`.
