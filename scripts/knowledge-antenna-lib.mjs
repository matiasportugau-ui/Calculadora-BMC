  ...
  return {
    ...
    sources: [
      ...
      },
      {
        ...
        apiUrl: "https://api.github.com/repos/anthropics/anthropic-sdk-typescript/releases",
        authorityScore: 0.95,
      ...
      {
        id: "openai-node-releases",
        name: "OpenAI Node SDK Releases",
        type: "github_releases",
        category: "developer-tooling",
        status: "active",
        url: "https://github.com/openai/openai-node/releases",
        apiUrl: "https://api.github.com/repos/openai/openai-node/releases",
        authorityScore: 0.96,
        projectFitWeight: 0.95,
        tags: ["openai", "sdk", "api", "typescript"],
        trustTier: "tier-1",
        evidenceLinks: ["https://github.com/openai/openai-node/releases"],
        createdAt,
        updatedAt: createdAt,
        lastCheckedAt: null,
        stats: { eventsSeen: 0, acceptedEvents: 0, rejectedEvents: 0, avgEventScore: 0 },
      },
      {
        ...
        apiUrl: "https://api.github.com/repos/vercel/ai/releases",
        authorityScore: 0.91,
        projectFitWeight: 0.89,
        tags: ["vercel", "ai-sdk", "agents", "tooling"],
        trustTier: "tier-1",
        evidenceLinks: ["https://github.com/vercel/ai/releases"],
        createdAt,
        updatedAt: createdAt,
        lastCheckedAt: null,
        stats: { eventsSeen: 0, acceptedEvents: 0, rejectedEvents: 0, avgEventScore: 0 },
      ...
      {
        id: "mcp-ts-sdk-releases",
        name: "MCP TypeScript SDK Releases",
        type: "github_releases",
        category: "developer-tooling",
        status: "active",
        url: "https://github.com/modelcontextprotocol/typescript-sdk/releases",
        apiUrl: "https://api.github.com/repos/modelcontextprotocol/typescript-sdk/releases",
        authorityScore: 0.9,
        projectFitWeight: 0.9,
        tags: ["mcp", "sdk", "typescript", "tools"],
        trustTier: "tier-1",
        evidenceLinks: ["https://github.com/modelcontextprotocol/typescript-sdk/releases"],
        createdAt,
        updatedAt: createdAt,
        lastCheckedAt: null,
        stats: { eventsSeen: 0, acceptedEvents: 0, rejectedEvents: 0, avgEventScore: 0 },
      },
      {
        ...
        authorityScore: 0.87,
        projectFitWeight: 0.8,
        tags: ["research", "open-models", "evaluation", "tools"],
        trustTier: "tier-2",
        evidenceLinks: ["https://huggingface.co/blog"],
        createdAt,
        updatedAt: createdAt,
        lastCheckedAt: null,
        stats: { eventsSeen: 0, acceptedEvents: 0, rejectedEvents: 0, avgEventScore: 0 },
