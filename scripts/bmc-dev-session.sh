...
# ── log dir ─────────────────────────────────────────────────────────────────
mkdir -p "$LOGS_DIR"
echo '{"gate":"idle","dev":"idle","smoke":"idle","ts":""}' > "$COORD"

# ── create session (no auto-attach yet) ─────────────────────────────────────
tmux new-session -d -s "$SESSION" -x 220 -y 50

# Pane 1 (ya existe como pane 0): dev:full
...
echo ""
echo "╔══════════════════════════════════════╗"
echo "║  BMC dev session iniciada            ║"
echo "║  Pane 1 → API :3001 + Vite :5173    ║"
echo "║  Pane 2 → log watcher               ║"
echo "║  Pane 3 → gate + auto-chain         ║"
echo "║  Pane 4 → ad-hoc / smoke            ║"
echo "╚══════════════════════════════════════╝"
echo ""
