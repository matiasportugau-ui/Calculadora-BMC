...
import createStorefrontLiveRouter from "./routes/storefrontLive.js";
...
import createCustomerTrackRouter from "./routes/customerTrack.js";
import createEnviosRouter from "./routes/envios.js";
import createRepartosRouter from "./routes/repartos.js";
import createTorreRouter from "./routes/torre.js";
...
app.use("/api", createCustomerTrackRouter(config, logger));
app.use("/api", createEnviosRouter(config, logger));
app.use("/api", createRepartosRouter(config, logger));
app.use("/api", createTorreRouter(config, logger));
