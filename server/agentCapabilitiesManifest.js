...
const DASHBOARD_ROUTES = [
  ...
  { method: "GET", path: "/api/productos-maestro", summary: "Catálogo unificado precio MATRIZ + stock E-Commerce" },
  { method: "GET", path: "/api/productos-maestro/reconcile", summary: "Reconcile gaps catálogo / stock / precios" },
  { method: "GET", path: "/api/productos-maestro/links", summary: "Links path calculadora ↔ codigo stock" },
  { method: "PUT", path: "/api/productos-maestro/links", summary: "Actualizar links path ↔ codigo stock" },
  { method: "POST", path: "/api/productos-maestro/push", summary: "Push unificado precios MATRIZ + stock (dryRun)" },
