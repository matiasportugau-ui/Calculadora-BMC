 ...
 * Used by authenticated routes so employee hours are not persisted in the
 * public quote-PDF bucket.
 ...
 * Prefer authenticated streaming via `renderHoursReportPdfBuffer` for new paths.
