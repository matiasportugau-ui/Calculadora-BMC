...
function compactCotizacion(parsed) {
  ...
  // comparar_escenarios — keep a/b scenario bags + deltas + voice nota
  // (otherwise compactCotizacion drops them → totals:null and invents prices)
  if (parsed.a != null || parsed.b != null) {
    if (parsed.a != null) out.a = parsed.a;
    if (parsed.b != null) out.b = parsed.b;
    if (parsed.delta_usd != null) out.delta_usd = parsed.delta_usd;
    if (parsed.delta_pct != null) out.delta_pct = parsed.delta_pct;
    if (parsed.nota != null) out.nota = parsed.nota;
    if (parsed.listaPrecios != null) out.listaPrecios = parsed.listaPrecios;
  }
