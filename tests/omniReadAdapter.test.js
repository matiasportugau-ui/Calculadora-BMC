...
const sugAcc = mapOmniSuggestion({ id: "s2", body: "x", metadata: {}, approval_state: "accepted", resolved_at: "t", created_at: "t" });
assert("sug: accepted → chosen_idx 0", sugAcc.chosen_idx === 0 && sugAcc.chosen_at === "t");
